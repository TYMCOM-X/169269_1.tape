...
Author. H. Mortensen.
*
*THIS PROGRAM WAS SUPPOSED TO CREATE AN UPDATED MASTER FILE
*FROM AN OLD MASTER AND PRODUCE TWO ERROR REPORTS.  I GOT
*IT TO COMPILE ON THE PDP-10 COMPUTER AT WORK BUT IT WON'T RUN
*DUE TO SOME SYSTEM REQUIREMENTS THAT I DO NOT UNDERSTAND.
*ERROR MESSAGES ARE ENCLOSED.
*
